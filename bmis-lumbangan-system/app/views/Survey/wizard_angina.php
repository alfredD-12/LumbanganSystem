              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q1_chest_discomfort" id="q1-yes" value="1" required>
                    <label class="form-check-label i18n" for="q1-yes" data-en="Yes" data-tl="Oo">Yes</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q1_chest_discomfort" id="q1-no" value="0">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q2_pain_location_left_arm_neck_back" id="q2-yes" value="1" required>
                    <label class="form-check-label i18n" for="q2-yes" data-en="Yes" data-tl="Oo">Yes</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q2_pain_location_left_arm_neck_back" id="q2-no" value="0">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q3_pain_on_exertion" id="q3-yes" value="1" required>
                    <label class="form-check-label i18n" for="q3-yes" data-en="Yes" data-tl="Oo">Yes</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q3_pain_on_exertion" id="q3-no" value="0">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q4_pain_relieved_by_rest_or_nitro" id="q4-yes" value="1" required>
                    <label class="form-check-label i18n" for="q4-yes" data-en="Yes" data-tl="Oo">Yes</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q4_pain_relieved_by_rest_or_nitro" id="q4-no" value="0">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q5_pain_lasting_10min_plus" id="q5-yes" value="1" required>
                    <label class="form-check-label i18n" for="q5-yes" data-en="Yes" data-tl="Oo">Yes</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q5_pain_lasting_10min_plus" id="q5-no" value="0">
          ...
          <div class="d-flex align-items-start">
            ...
            <div class="flex-grow-1">
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q6_pain_front_of_chest_half_hour" id="q6-yes" value="1" required>
                    <label class="form-check-label i18n" for="q6-yes" data-en="Yes" data-tl="Oo">Yes</label>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-check">
                    <input class="form-check-input" type="radio" name="q6_pain_front_of_chest_half_hour" id="q6-no" value="0">

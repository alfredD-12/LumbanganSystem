...
<head>
  ...
  <!-- Document Request modern styles (applies to dynamically generated cards) -->
  <link rel="stylesheet" href="<?php echo BASE_URL . 'assets/css/resident/document_request_modern.css'; ?>">
    ...
    <div class="container">
      <a class="navbar-brand" href="#dashboard">
        ...
        <div>
          ...
          <small class="text-mut  ed">Resident Portal</small>
        </div>
      </a>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title"><i class="fas fa-id-card me-2"></i> Profile</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
        <div class="modal-body">
          <div class="mb-3"><strong>Name</strong>
            <div id="wf_profile_name" class="text-muted"><?php echo h($hdr_full_name); ?></div>
          </div>
          <div class="mb-3"><strong>Username</strong>
            <div id="wf_profile_username" class="text-muted">@<?php echo h($hdr_username); ?></div>
          </div>
          <div class="mb-3"><strong>Email</strong>
            <div id="wf_profile_email" class="text-muted"><?php echo h($hdr_email); ?></div>
          </div>
          <div class="mb-3"><strong>Mobile</strong>
            <div id="wf_profile_mobile" class="text-muted"><?php echo h($hdr_mobile); ?></div>
          </div>
        </div>
